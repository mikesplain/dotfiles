...
alias ktmux="tmux new-session -d 'watch -n.5 kubectl get nodes -L fullType,type' && tmux split-window -h 'watch -n.5 kubectl get pods --all-namespaces' && tmux split-window -v -t 1 && tmux -2 attach-session -d"
